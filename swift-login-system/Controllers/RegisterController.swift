...
class RegisterController: UIViewController {
    ...
    private let termsTextView: UITextView = {
            ...
            let attributedString = NSMutableAttributedString(string: " By creating that account ,you agrrree to our Terms & Conditions and you acknowledge that you have read our Privacy & Policy")
...
extension RegisterController: UITextViewDelegate {
    private func textView(_ textView: UITextView, shouldIntreactWith URL: URL, in chracterRange: NSRange, interaction: UITextInteraction)-> Bool {
